...
local function ApplyBackground(bu)
  ...
  bu.bg.Backdrop:SetBackdrop(backdrop1)
    ...
    if cfg.background.showshadow then
      bu.bg.Backdrop:SetBackdropBorderColor(cfg.background.shadowcolor.r,cfg.background.shadowcolor.g,cfg.background.shadowcolor.b,cfg.background.shadowcolor.a)
    end
  end
end
...
local function StyleButtons(actionBar, buttonCount)
  ...
  if not buttonCount then return end
  ...
  for i = 1, buttonCount do
    ...
    _G[actionBar..i..'NormalTexture']:SetVertexColor(cfg.actionbar_colors.normal.r,cfg.actionbar_colors.normal.g,cfg.actionbar_colors.normal.b,1)
    ...
    if text2 then
      ...
      text2:SetVertexColor(cfg.actionbar_colors.normal.r,cfg.actionbar_colors.normal.g,cfg.actionbar_colors.normal.b,1)
    end
    ...
    if action and IsEquippedAction(action) then
      _G[actionBar..i..'NormalTexture']:SetVertexColor(cfg.actionbar_colors.equipped.r,cfg.actionbar_colors.equipped.g,cfg.actionbar_colors.equipped.b,1)
    end
